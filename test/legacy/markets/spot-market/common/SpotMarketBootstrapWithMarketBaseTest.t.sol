...
import {CannonScript as SpotMarket} from "test/legacy/cannon/schemas/synth-spot-market.cannon.sol";
...
contract SpotMarketBootstrapWithMarketBaseTest is BaseLegacyTest {
    ...
    function _createPythNode(address owner, uint256 price)
        internal
        returns (bytes32 oracleNodeId, address aggregator)
    {}
}
